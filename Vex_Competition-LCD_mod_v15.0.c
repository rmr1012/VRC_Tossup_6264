...
void curvebackward(int power,int left,int right);
void curveforward(int power,int left,int right);
void forward_drift(int power,int dpower,int howfar);
void backward_drift(int power,int dpower,int howfar);
...
void curveforward(int power,float left,float right)
{
	int leftpower;
	float rightpower;
	if(left>right)
	{
		leftpower=power;
		rightpower=(float)((right*power)/left);
	}
	else if(right>left)
	{
		leftpower=(float)((left*power)/right);
		rightpower=power;
	}
	nMotorEncoder[backRight] = 0;
	nMotorEncoder[backLeft] = 0;
	while(nMotorEncoder[backRight] < right | nMotorEncoder[backLeft] < left )
	{
		if(nMotorEncoder[backRight] < right ){
		...
		if(nMotorEncoder[backLeft] < left ){
...
void curvebackward(int power,float left,float right)
{
	float leftpower;
	float rightpower;
	if(left>right)
	...
	nMotorEncoder[backRight] = 0;
	nMotorEncoder[backLeft]  = 0;
	while(nMotorEncoder[backRight]+right>10 | nMotorEncoder[backLeft]+left>10)
	{
		if(nMotorEncoder[backRight] > -right ){
			motor[backRight] = -rightpower;
			motor[frontRight] = -rightpower;}
		else if(nMotorEncoder[backRight]<-right){
			motor[backRight] = 0;
			motor[frontRight] = 0;}
		...
		if(nMotorEncoder[backLeft] > -left){
			motor[backLeft] = -leftpower;
			motor[frontLeft] = -leftpower;}
		else if(nMotorEncoder[backLeft]<-left){
			motor[backLeft] = 0;
			motor[frontLeft] = 0;}
	}
	motor[frontRight] = 0;
...
void backward_drift(int power,int dpower,int howfar)//backright is the refrence
{

	nMotorEncoder[backRight] = 0;
	while(nMotorEncoder[backRight]+howfar>10 )
	{
		motor[frontLeft] = -power - dpower;
		motor[frontRight] = -power  + dpower;
		motor[backRight] =  -power - dpower;
		motor[backLeft] =  -power  + dpower;
...
void forward_drift(int power,int dpower,int howfar)//backright is the refrence
{
